...
def load_json_files():
    ...
    file1 = PROCESSED_DATA_DIR / "tenant_law_summaries.json"
    file2 = PROCESSED_DATA_DIR / "comprehensive_tenant_law.json"
...
def main():
    ...
    # Save unified file
    output_file = PROCESSED_DATA_DIR / "unified_tenant_law_knowledge.json"
